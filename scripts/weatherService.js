...
.service('weatherService', function($http){
  ...
  this.getProvoWeather = function(){
    return $http({
      method: 'GET',
      url:'https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20weather.forecast%20where%20woeid%20in%20(select%20woeid%20from%20geo.places(1)%20where%20text%3D%22provo%2C%20ut%22)&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys'
    })
  }

  this.getSfWeather = function(){
    return $http({
      method: 'GET',
      url:'https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20weather.forecast%20where%20woeid%20in%20(select%20woeid%20from%20geo.places(1)%20where%20text%3D%22San%20Francisco%2C%20ca%22)&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys'
    })
  }

  this.iconFunction = function(condid) {
                var icon = '';
                switch(condid) {
